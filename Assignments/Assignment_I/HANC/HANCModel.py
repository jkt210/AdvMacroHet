...
class HANCModelClass(EconModelClass,GEModelClass):    
    ...
    def settings(self):
        ...
        self.inputs_hh = ['r','w0','w1'] # direct inputs
    ...
    def setup(self):
        ...
        par.phi_low = 1.0 # low ability
        par.phi_high = 2.0 # high ability

        par.eta0

        par.chi_low = 0.0 # low ability
        par.chi_low_prob = 2/3 # probability for low ability
        par.chi_high = 1.0 # high ability
        par.chi_high_prob = 1/3 # probability for high ability
    ...
    def allocate(self):
        ...
        par.eta_grid = np.zeros(par.Nfix)
